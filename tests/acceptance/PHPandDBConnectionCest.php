...
class PHPandDBConnectionCest
{
    public function _before(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand("docker exec phantom_web git clone -b db-creation-drop https://github.com/orangehrm/environment-test-helpers.git db-creation-drop");
    ...
    public function _after(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand('docker exec phantom_web rm -rf /var/www/html/db-creation-drop');
    }
    ...
    public function checkSampleApp(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec phantom_web php /var/www/html/db-creation-drop/app.php");
