...
class ContainerConnectionsCest
{
    public function _before(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand("docker exec flash_web git clone -b db-creation https://github.com/orangehrm/environment-test-helpers.git db-creation");
    ...
    public function _after(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand('docker exec flash_web rm -rf /var/www/html/db-creation');
