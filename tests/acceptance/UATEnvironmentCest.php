...
class UATEnvironmentCest
{
    public function _before(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand("docker exec jade_web git clone https://github.com/ChanakaR/php-simple.git /var/www/html/php-simple");
    ...
    public function _after(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand('docker exec jade_web rm -rf /var/www/html/php-simple');
    }
    ...
    public function checkSampleApp(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec jade_web php /var/www/html/php-simple/app.php");
        $I->cantSeeInShellOutput("false");
    }

//    public function checkSampleApp(AcceptanceTester $I){
//        $I->wantTo("verify uat environment is working properly with a php application");
//        $I->runShellCommand("docker exec jade_web php /var/www/html/OHRMStandalone/TEST/php-simple/app.php");
//        $I->cantSeeInShellOutput("false");
//    }
