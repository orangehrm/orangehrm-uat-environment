...
class DBConfigCest
{
    ...
    public function testEnvironmentVariable_max_allowed_packet(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'max_allowed_packet'\"");
    ...
    public function testEnvironmentVariable_event_scheduler(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'event_scheduler'\"");
    ...
    public function testEnvironmentVariable_connect_timeout(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'connect_timeout'\"");
    ...
    public function testEnvironmentVariable_innodb_buffer_pool_size(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'innodb_buffer_pool_size'\"");
    ...
    public function testEnvironmentVariable_innodb_log_buffer_size(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'innodb_log_buffer_size'\"");
    ...
    public function testEnvironmentVariable_innodb_log_file_size(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'innodb_log_file_size'\"");
    ...
    public function testEnvironmentVariable_innodb_lock_wait_timeout(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'innodb_lock_wait_timeout'\"");
    ...
    public function testEnvironmentVariable_delayed_insert_timeout(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'delayed_insert_timeout'\"");
    ...
    public function testEnvironmentVariable_net_read_timeout(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'net_read_timeout'\"");
        $I->seeInShellOutput("30");
    }
    ...
    public function testEnvironmentVariable_net_write_timeout(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'net_write_timeout'\"");
    ...
    public function testEnvironmentVariable_slave_net_timeout(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'slave_net_timeout'\"");
    ...
    public function testEnvironmentVariable_wait_timeout(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'wait_timeout'\"");
        $I->seeInShellOutput("600");
    }
    ...
    public function testEnvironmentVariable_interactive_timeout(UnitTester $I){
        ...
        $I->runShellCommand("docker exec flash_mysql mysql -uroot -p1234 -e \"show variables like 'interactive_timeout'\"");
        $I->seeInShellOutput("600");
    }
}