...
class WebContainerCest
{
  ...
  public function checkContainerIsRunning(UnitTester $I){
    ...
    public function checkPHPVersion(UnitTester $I){
        ...
        $I->runShellCommand("docker exec phantom_web php --version");
...
//    }
    ...
    public function checkCronServiceIsRunning(UnitTester $I){
        ...
        $I->runShellCommand("docker exec phantom_web service crond status");
        $I->seeInShellOutput('active (running)');
    }
    ...
    public function checkSSHServiceRunning(UnitTester $I){
            ...
            $I->runShellCommand("docker exec phantom_web service sshd status");
            $I->seeInShellOutput('active (running)');
    }

    public function checkNSSPAMLDAPInstallation(UnitTester $I){
            $I->wantTo("verify nss-pam-ldapd is installed in the container");
            $I->runShellCommand("docker exec phantom_web rpm -qa | grep nss-pam-ldapd");
    ...
    public function checkJavaVersion(UnitTester $I){
            ...
            $I->runShellCommand("docker exec phantom_web rpm -qa | grep java-1.8.0-openjdk");
